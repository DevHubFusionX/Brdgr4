...
export default function NavLogo({
  ...
  return (
    ...
    >
      ...
      {/* ─── Crisp Dark Slate Wordmark ─── */}
      <span className="text-slate-900 group-hover:text-[#0364FF] text-[18px] sm:text-[19px] md:text-[20px] font-bold tracking-tight leading-none transition-colors duration-200">
        BRDGR
      </span>
    </Link>
  );
