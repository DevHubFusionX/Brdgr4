  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="hidden sm:block absolute top-0 left-0 w-[420px] h-[420px] bg-[radial-gradient(ellipse_at_top_left,rgba(147,197,253,0.55)_0%,rgba(191,219,254,0.35)_40%,transparent_70%)] pointer-events-none"
          aria-hidden="true"
        />
        ...
        {/* ─── Bottom-Right: Soft Blue Gradient Wash (Desktop Card Only) ──────────── */}
        <div
          className="hidden sm:block absolute bottom-0 right-0 w-[420px] h-[420px] bg-[radial-gradient(ellipse_at_bottom_right,rgba(147,197,253,0.55)_0%,rgba(191,219,254,0.35)_40%,transparent_70%)] pointer-events-none"
          aria-hidden="true"
        />
        ...
        {/* ─── Hero Content (Direct on mobile background, Framed on desktop) ──── */}
        <div className="relative z-10 px-2 sm:px-12 md:px-16 py-6 sm:py-18 md:py-20 lg:py-24 text-center flex flex-col items-center">
          {/* ─── Headline (Responsive on all screen sizes) ─── */}
          <h1 className="text-[29px] sm:text-4xl md:text-[44px] lg:text-[50px] xl:text-[52px] font-normal text-neutral-900 tracking-[-0.025em] sm:tracking-[-0.03em] leading-[1.16] sm:leading-[1.18] max-w-4xl text-center">
